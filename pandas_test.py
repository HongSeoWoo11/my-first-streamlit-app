...
# --- Streamlit 앱 제목 설정 ---
st.title('🐼 Pandas로 요원 선호도 데이터 만들기')
st.write("학급별 요원 선호도 데이터를 랜덤으로 생성하고, Streamlit 표로 확인하는 실습입니다.")
st.write("---")

# --- 데이터 준비 ---
# 설문 대상 음식과 학급 리스트를 정의합니다.
foods = ['하버', '제트', '피닉스', '요루', '사이퍼']
...
st.header("학급별 요원 선호도 투표 결과 (랜덤)")
# 생성된 데이터프레임을 Streamlit 화면에 표로 표시합니다.
st.dataframe(df)

st.header("요원별 총 득표수")
st.write("각 요원의 총 득표수를 계산한 결과입니다.")
